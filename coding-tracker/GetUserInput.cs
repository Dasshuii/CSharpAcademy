...
internal class GetUserInput
{
    ...
    private void ProcessDelete()
    {
        ...
        string commandInput = Console.ReadLine();
        while (!Int32.TryParse(commandInput, out_) || string.IsNullOrEmpty(commandInput) || Int32.Parse(commandInput) < 0)
        {
    ...
    private void ProcessUpdate()
    {
        ...
        {
            Console.WriteLine($"\nRecord with id {id} doesn't exist\n");
            Console.WriteLine("\nPlease add id of the category you want to update (or 0 to return to Main Menu).\n");
    ...
    internal string GetDurationInput()
    {
        ...
        {
            Console.WriteLine("\n\nDuration invalid. Please insert the duration: (Format: hh:mm) or type 0 to return.\n\n");
